...
VALUES('CARRO2','2022-10-07',2600,155,5,3,1,'2027-10-07',150000,'asistente voz','IA','Explorador','Farol grand','Grand-vitara-1.png','Grand-vitara-2.png','Grand-vitara-3.png','Grand-vitara-4.png','Grand-vitara-5.png','Grand-vitara-video','El Suzuki Vitara, Suzuk es un automóvil todoterreno producido por el fabricante japonés Suzuki. Posee motor delantero longitudinal, se ofrece con tracción trasera o a las cuatro ruedas, y en versiones de 3 y 5 puertas.',1,2,1,2,3),
('MOTO2','2022-10-07',1200,95,6,0,0,'2027-10-07',150000,'pantalla','IA','RAIN','Antiniebla','Sportster-S-1.png','Sportster-S-2.png','Sportster-S-3.png','Sportster-S-4.png','Sportster-S-5.png','Sportster-S-video','¿Qué tanto co experto? Sin importar que estés iniciando en el mundo de las dos ruedas o cuentes con años de experiencia, es sumamente importante conocer hasta el último de los elementos que componen a este vehículo. Aquí aprenderás todo sobre las partes de la moto ',2,3,4,1,1);
...
DELIMITER //
CREATE OR replace PROCEDURE contactos (in correo VARCHAR(50),in numero INT, IN modeloAuto VARCHAR(50),IN modeloMoto VARCHAR(50),IN Irepuesto VARCHAR(50),IN Icompra VARCHAR(50), IN Itest VARCHAR(50), IN Iinfo VARCHAR(50), IN descrip VARCHAR(200))
 BEGIN
 ...
 VALUES(correo,numero,modeloAuto,modeloMoto,Irepuesto,Icompra,Itest,Iinfo,descrip);
 END;
//
DELIMITER ;
...
-- CALL mostrar();
-- CALL contactanos ("hola@gmail.com",32954,"modelo3","moto2", "0","0","interesado", "interesado","vamos a fumar marihuanaaaaaaa");
